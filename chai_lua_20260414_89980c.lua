--[[
    ...
    ║                     For Delta Executor                           ║
    ║   FIXED: Teleport only to survivors, GUI logo kotak kecil       ║
    ║   FIXED: GUI & logo tahan cutscene (CoreGui)                    ║
    ╚═══════════════════════════════════════════════════════════════════╝
--]]
...
-- ============================================================================
-- FEATURE 15: TELEPORT TO NEAREST SURVIVOR (BUKAN KILLER) - FIXED
-- ============================================================================
...
-- ============================================================================
-- FEATURE 16: MODERN GUI (UKURAN KECIL, TAHAN CUTSCENE, LOGO KOTAK RGB)
-- ============================================================================
...
local function createFloatingLogo()
    ...
    floatingLogo.Size = UDim2.new(0, 35, 0, 35)   -- ukuran kotak kecil
    ...
    corner.CornerRadius = UDim.new(0, 6)   -- sedikit rounded, tetap kotak
...
-- Tombol teleport permanen (bulat, terpisah) - tetap teleport ke survivor
local function createPermanentTeleportButton()
    ...
    teleportButtonGui.Parent = CoreGui  -- juga di CoreGui agar tahan cutscene
    ...
    teleportButton.MouseButton1Click:Connect(teleportToNearestSurvivor)  -- teleport ke survivor terdekat
    -- Draggable
