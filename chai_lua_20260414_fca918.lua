--[[
    ╔═══════════════════════════════════════════════════════════════════╗
    ║                    CYBERHEROES DELTA EXECUTOR v6.0               ║
...
local config = {
    ...
    boostAmount = 20,              -- Increased for noticeable effect
    boostDuration = 3,
    ...
    autoGeneratorEnabled = true,       -- Auto generator repair
    guiVisible = true,
...
local generatorRemoteEvent = nil               -- Cached remote event for auto generator
...
local function init()
    print("╔═══════════════════════════════════════════════════════════════════╗")
    print("║                    CYBERHEROES DELTA EXECUTOR v6.0               ║")
