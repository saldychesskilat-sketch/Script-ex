--[[
    ╔═══════════════════════════════════════════════════════════════════╗
    ║                    CYBERHEROES DELTA EXECUTOR v3.6               ║
    ...
    ║                     For Delta Executor                           ║
    ║   FIXED: Script restart button now working properly             ║
    ║   FIXED: Auto Win & Auto Task more reliable                     ║
    ╚═══════════════════════════════════════════════════════════════════╝
    ...
    ✅ SCRIPT RESTART - Restart script without re-executing (NOW WORKING!)
...
-- ============================================================================
-- FEATURE 2: AUTO TASK (OPTIMIZED WITH FALLBACK PATHFINDING)
-- ============================================================================
...
-- ============================================================================
-- FEATURE 8: SCRIPT RESTART (FIXED: NOW USES RELOAD FUNCTION)
-- ============================================================================
...
-- ============================================================================
-- FEATURE 9: MODERN GUI WITH MINI LOGO (RESTART BUTTON FIXED)
-- ============================================================================
...
local function init()
    print("╔═══════════════════════════════════════════════════════════════════╗")
    print("║                    CYBERHEROES DELTA EXECUTOR v3.6               ║")
