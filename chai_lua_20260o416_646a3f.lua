--[[
    ...
    ║                     For Delta Executor                           ║
    ║   NEW: Auto Escape (Teleport to Exit Gate)                      ║
    ║   NEW: Anti-Hook (Knockback Killer when grabbed)                ║
    ║   NEW: Enhanced ESP (Killer, Survivor, Generator, Gate)         ║
    ║   NEW: TPWalk (Speed Boost when killer nearby)                  ║
    ║   FIXED: GUI 2x smaller, persistent, mobile drag               ║
    ╚═══════════════════════════════════════════════════════════════════╝
--]]
...
-- ============================================================================
-- FEATURE 1: AUTO ESCAPE (TELEPORT TO EXIT GATE)
-- ============================================================================
local function findExitGate()
    local exitGate = nil
    for _, obj in ipairs(Workspace:GetDescendants()) do
        if obj:IsA("BasePart") and (obj.Name:lower():find("gate") or obj.Name:lower():find("exit") or obj.Name:lower():find("door")) then
            exitGate = obj
            break
        end
    end
...
-- ============================================================================
-- FEATURE 10: TPWALK (Speed Boost when killer nearby)
-- ============================================================================
...
-- ============================================================================
-- FEATURE 17: MODERN GUI (2x SMALLER, PERSISTENT, MOBILE DRAG)
-- ============================================================================
...
local function createGUI()
    ...
    gridLayout.CellSize = UDim2.new(0, 70, 0, 26)
    ...
    local features = {
        {name="autoEscapeEnabled", text="AUTO ESCAPE"},
        ...
        {name="autoSkillCheckEnabled", text="SKILL CHK"},
