...
-- ============================================================================
-- LIST OF VALID KEYS (ADD YOUR KEYS HERE)
-- ============================================================================
local validKeys = {
    "kemilinux227",   -- key 1
    "key2",     -- ganti dengan key kedua Anda
    "key3"      -- ganti dengan key ketiga (opsional, bisa ditambah)
...
local function createLoginPanel()
    ...
    -- ============================================================================
    -- SUBMIT ACTION WITH MULTIPLE KEYS SUPPORT
    -- ============================================================================
...
initialize()    fill.Parent = loadingFrame
    local tween = TweenService:Create(fill, TweenInfo.new(duration, Enum.EasingStyle.Linear), {Size = UDim2.new(1, 0, 1, 0)})
    tween:Play()
    tween.Completed:Connect(function()
        loadingFrame:Destroy()
...
local function createLoginPanel()
    ...
    local validKeys = {
        "kemilinux227",
        "key2_disini"  -- ganti dengan key kedua yang diinginkan
    }
