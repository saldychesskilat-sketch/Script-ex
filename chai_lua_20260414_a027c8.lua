--[[
    ...
    ║                     For Delta Executor                           ║
    ║   NEW: GUI terpisah (menu utama + tombol teleport permanen)     ║
    ║   NEW: Sidebar + Panel grid layout (4 kolom)                    ║
    ╚═══════════════════════════════════════════════════════════════════╝
--]]
...
-- ============================================================================
-- FEATURE 16: MODERN GUI (SIDEBAR + PANEL GRID) + TOMBOL TELEPORT PERMANEN
-- ============================================================================
...
-- Tombol teleport permanen (terpisah dari menu utama)
...
-- Main GUI dengan sidebar + grid panel
local function createGUI()
    ...
    -- Main window (background luas, semi-transparan)
    ...
    -- Items (hanya dekorasi, tidak ada fungsi khusus)
    ...
    -- Panel kanan (grid 4 kolom)
    contentPanel = Instance.new("Frame")
    contentPanel.Size = UDim2.new(1, -170, 1, -42)
    contentPanel.Position = UDim2.new(0, 170, 0, 38)
    contentPanel.BackgroundTransparency = 1
    contentPanel.Parent = mainFrame
    local gridLayout = Instance.new("UIGridLayout")
    gridLayout.CellSize = UDim2.new(0, 110, 0, 45)
...
local function init()
    ...
    createGUI()
    createPermanentTeleportButton()  -- Tombol teleport permanen
    startAllSystems()
end
task.wait(1)
init()