...
local function autoParryLoop(remotePath)
...
local function updateActiveKiller()
    ...
    local radius = 10  -- bisa disesuaikan, atau ambil dari config jika ada
...
local function createHomeContent()
    ...
    logo.Image = "rbxassetid://102892318420171"
...
local function createGUI()  
    ...
    local homeItem = createSidebarItem(sidebarList, "HOME", "", false)   -- awal false dulu  
    ...
    -- Sinkronisasi: aktifkan tampilan HOME secara default  
