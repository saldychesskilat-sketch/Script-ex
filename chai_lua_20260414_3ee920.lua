--[[
    ╔═══════════════════════════════════════════════════════════════════╗
    ║                    CYBERHEROES DELTA EXECUTOR v8.2               ║
    ...
    ║                     For Delta Executor                           ║
    ║   NEW: GUI ukuran 2x lebih kecil, logo RGB, tahan cutscene      ║
    ║   FIXED: GUI tidak hilang saat cutscene (CoreGui)               ║
    ╚═══════════════════════════════════════════════════════════════════╝
--]]
...
-- ============================================================================
-- FEATURE 16: MODERN GUI (UKURAN KECIL, TAHAN CUTSCENE, LOGO RGB)
-- ============================================================================
...
local function createFloatingLogo()
    ...
    floatingLogo.Size = UDim2.new(0, 30, 0, 30)  -- ukuran kecil
...
-- Tombol teleport permanen (tetap di PlayerGui, tidak perlu diubah)
local function createPermanentTeleportButton()
    ...
    teleportButton.MouseButton1Click:Connect(teleportToNearestPlayer)
...
local function createGUI()
    ...
    -- Fungsi untuk menyembunyikan GUI dan menampilkan logo
...
local function init()
    print("╔═══════════════════════════════════════════════════════════════════╗")
    print("║                    CYBERHEROES DELTA EXECUTOR v8.2               ║")
