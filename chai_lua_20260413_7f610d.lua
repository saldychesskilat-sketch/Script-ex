--[[
    ╔═══════════════════════════════════════════════════════════════════╗
    ║                    CYBERHEROES DELTA EXECUTOR v3.7               ║
    ...
    ║                     For Delta Executor                           ║
    ║   NEW: Auto Shield - ForceField when killer distance ≤30 studs   ║
    ║   OPTIMIZED: Auto Win & Auto Task - Enhanced detection           ║
    ╚═══════════════════════════════════════════════════════════════════╝
    ...
    ✅ AUTO SHIELD - ForceField protection when killer within 30 studs (NEW!)
...
local config = {
    ...
    shieldEnabled = true,          -- NEW: Auto Shield toggle
    shieldRadius = 30,             -- NEW: Distance to activate shield
    guiVisible = true,
...
local shieldConnection = nil          -- NEW: Connection for shield monitoring
local currentForceField = nil         -- NEW: Reference to active ForceField
local isShieldActive = false          -- NEW: Shield state
...
-- ============================================================================
-- FEATURE 10: MODERN GUI WITH MINI LOGO (RESTART BUTTON FIXED + SHIELD TOGGLE)
-- ============================================================================
...
local function createGUI()
    ...
    mainFrame.Size = UDim2.new(0, 260, 0, 400)  -- Increased height for new shield feature
